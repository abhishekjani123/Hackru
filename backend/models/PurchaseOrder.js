...
const purchaseOrderSchema = new mongoose.Schema({
  ...
  vendor: {
    type: mongoose.Schema.Types.ObjectId,
    ref: 'Vendor',
    required: false  // Made optional for AI-discovered vendors
  },
  // For AI-discovered online vendors (not in database)
  vendorDetails: {
    vendorId: String,  // AI vendor ID (e.g., "realistic_4")
    name: String,
    source: String,  // e.g., "Amazon Business", "Alibaba"
    country: String,
    rating: Number,
    deliveryTime: Number,
    isOnline: Boolean
